...
public partial class MainViewModel : ObservableObject
{
    ...
    private async Task Launch()
    {
        ...
        string customConfigurationFileContent = new StringBuilder()
            .AppendLine("// init.cfg auto-generated by WILLOWMAKER")
            .AppendLine("// configuration file load order: 1) startup.cfg, 2) login.cfg, 3) init.cfg, 4) autoexec.cfg")
            .AppendLine()
            .AppendLine("// performance")
            .AppendLine("setsave host_affinity -1")
            .AppendLine()
            .AppendLine("// debugging")
            .AppendLine("setsave http_printdebuginfo true")
            .AppendLine("setsave php_printdebuginfo true")
            .AppendLine()
            .AppendLine("// console (CTRL+F8)")
            .AppendLine("setsave con_height 0.50")
            .AppendLine("setsave con_alpha 0.25")
            .ToString();
